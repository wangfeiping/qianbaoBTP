...
create table TB_User(
	User_ID bigint primary key,--  会员编号
...
create table TB_Bill(
	Bill_ID bigint primary key,-- 票据编号
...
create table TB_Account(
	Account_ID bigint primary key,-- 用户账户编号
	Account_GuaranteedID bigint,-- 担保账户编号
	Account_CreditID bigint-- 授信账户编号
);

-- 担保账户表
create table TB_Guarateed(
	Guaranteed_ID bigint primary key,-- 担保账户编号
...
create table TB_Credit(
	Credit_ID bigint primary key,-- 授信账户编号
...
create table TB_CreditOrganization(
	CreditOrganization_ID bigint primary key,-- 授信机构编号
	CreditOrganization_Name varchar(100)-- 授信机构名称
);

-- 授信记录表
create table TB_CreditRecord(
	CreditRecord_ID bigint primary key,-- 授信记录编号
...
create table TB_Payment(
	Payment_ID bigint primary key,-- 支付订单编号
...
create table TB_Deal(
	Deal_ID bigint primary key,-- 交易信息编号
